...
;--- Skriv dose matrise og ROI indeks til fil ---
...
;Skriver egentlig ut informasjonen funnet til .dat filer
ans = ''
...
end  ;Kommenter ut end her og kommenter inn linjene nedenfor for å eksportere til DICOM. OBS! Dicom lisens trengs.
;for i=0, n_elements(store_matrix[*, 10])-1 do begin 
